  ...
  PageRouter.prototype = {
    ...
    */
    _runWithInvocation: function (page, context) {
      ...
      self._invocationHandle = Deps.autorun(function (computation) {
  ...
  */
  var MeteorExtensions = {
    ...
    */
    ...
    /**
      Convenience method to fetch the currently applied 
      {{#crossLink "PageInvocation"}}{{/crossLink}} instance.

      @attribute Meteor.currentPage
    */
    currentPage: function (value) {
      return Meteor.router.invocation(value);
    }
  };

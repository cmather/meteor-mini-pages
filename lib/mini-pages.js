(function () {
  ...
  /* Provide a restart() method in a page-js Context instance */
  pagejs.Context.prototype.restart = function () {
    this.stopped = false;
  ...
  PageRouter.Page.prototype = {
    ...
    */
    run: function (invocation) {
      ...
      // browser URL does not match the url for this page invocation
      if(document.location.href.substr(document.location.origin.length) != invocation.context.canonicalPath){
        invocation.context.save();
      }
  ...
  */
  ...
  PageRouter.PageInvocation.prototype = {
    ...
    */
    ...
    /**
      Re-enables the current page run. Also re-enables pushState to be called. Call
      this to allow proper url updating after stop() has been called on this instance.
